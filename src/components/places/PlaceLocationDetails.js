  ...
  render() {
    if (this.props.place) {
      return (
        <Row>
          <Col xs={24}>
            {this.props.showMap && this.props.mapInfo && (
              <SingleMarkerMap point={this.props.mapInfo} />
            )}
          </Col>
          <Col xs={24} sm={this.hoursAvailable() ? 14 : 24}>
            ...
            {this.props.place.address2.length > 0 && <br />}
            ...
            {this.props.place.phone && this.props.place.website && (
...
const mapStateToProps = (state, props) => {
  return {
    place: props.place
      ? props.place
      : selectPlaceById(props.placeId, state.activeTrip.places.data),
  };
};
